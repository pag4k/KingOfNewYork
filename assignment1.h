...
void PrintNeighbours(FGraph<int> &Graph, std::string Name)
{
...
void PrintAdjacent(FGraph<int> &Graph, std::string Name1, std::string Name2)
{
    std::cout   << "Is "
                << Name1
                << " adjancent with "
...
void PrintDiceResult(std::vector<EDiceFace> &DiceResult)
{
